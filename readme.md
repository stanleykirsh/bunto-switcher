...
Программа для автоматического переключения между раскладками клавиатуры в Linux.

![Markdown image](demo_switch.gif)

## Возможности

* Автоматическое исправление текста в реальном времени.
